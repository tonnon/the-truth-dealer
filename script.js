...
commonColor.setHSL( commonHue, .4, .5 );
...
const mountains = {
 ...
 create( scene ) {
  ...
  this.geometry = new THREE.PlaneGeometry( 16000, 1200, 158, 32 ); 
  ...
  let light = new THREE.PointLight( 0x471c57, 25, 5800 );
...
const groundPlain = {
 ...
 create( scene ) {
  ...
  this.geometry = new THREE.PlaneGeometry( 4000, 2000, 128, 94 ); 
